...
class Fixnum
  ...
  # NOTE: this doesn't quite work about 999
  def to_english
    ...
    if write > 0
      ...
      #  we originally called to_english with 1999 (so "number" =  1999),
      #  then at this point "write" would be 19, and "left" would be 99.
      #  The laziest thing to do at this point is to have to_english
      #  write out the 'nineteen' for us, then we write out ' hundred',
      #  and then the rest of to_english writes out 'ninety-nine'.
